...
export const translations = {
  en: {
    ...
    hero: {
      ...
      description: 'Professional veterinary services in the heart of Rabat, Morocco. We provide comprehensive care for all your furry, feathered, and scaled family members.',
      cta: 'Book Appointment',
      emergency: 'Emergency Care'
    },
    services: {
      title: 'Our Services',
      subtitle: 'Comprehensive veterinary care for your pets',
      wellness: {
        title: 'Wellness Exams',
        description: 'Regular health checkups to keep your pet healthy and happy'
      },
      vaccination: {
        title: 'Vaccinations',
      ...
      surgery: {
        title: 'Surgery',
        description: 'Advanced surgical procedures performed with care and precision'
      },
      dental: {
        title: 'Dental Care',
    ...
    about: {
      ...
      mission: 'Our overarching mission is to deliver veterinary care that is both deeply compassionate and of the highest quality to cherished pets across Rabat and its surrounding regions. We firmly believe that every single animal entrusted to our care is deserving of the absolute best possible treatment, reflecting our unwavering commitment to their well-being.',
      missionExtra: 'Strategically located in the very heart of Rabat, our clinic seamlessly integrates the most modern veterinary technology with a philosophy of traditional, heartfelt compassionate care. This unique blend allows us to offer comprehensive health services tailored to the diverse needs of all types of pets, ensuring they receive well-rounded and exceptional medical attention in an environment where their comfort and health are always the top priority.',
    ...
    contact: {
      title: 'Contact Us',
      subtitle: 'Get in touch for appointments or emergencies',
      address: 'Address',
      phone: 'Phone',
      email: 'Email',
  ...
  fr: {
    ...
    hero: {
      title: 'SOS Vet',
      subtitle: 'Soins Compassionnels pour Vos Animaux Bien-Aimés',
      description: 'Services vétérinaires professionnels au cœur de Rabat, Maroc. Nous fournissons des soins complets pour tous vos membres de famille à poils, à plumes et à écailles.',
      cta: 'Prendre Rendez-vous',
      emergency: 'Soins d\'Urgence'
    },
    services: {
      title: 'Nos Services',
      subtitle: 'Soins vétérinaires complets pour vos animaux',
      wellness: {
        title: 'Examens de Bien-être',
        description: 'Contrôles de santé réguliers pour garder votre animal en bonne santé et heureux'
      },
      vaccination: {
        title: 'Vaccinations',
        description: 'Programmes de vaccination complets pour protéger votre animal des maladies'
      },
      surgery: {
        title: 'Chirurgie',
        description: 'Procédures chirurgicales avancées effectuées avec soin et précision'
      },
      dental: {
        title: 'Soins Dentaires',
        description: 'Nettoyage dentaire professionnel et maintien de la santé bucco-dentaire'
      },
      emergency: {
        title: 'Soins d\'Urgence',
        description: 'Services d\'urgence 24h/24 pour les situations de santé urgentes des animaux'
      },
      grooming: {
        title: 'Toilettage',
    ...
    about: {
      ...
      mission: 'Notre mission primordiale est de fournir des soins vétérinaires à la fois profondément compatissants et de la plus haute qualité aux animaux de compagnie chéris à travers Rabat et ses régions environnantes. Nous croyons fermement que chaque animal qui nous est confié mérite le meilleur traitement possible, reflétant notre engagement inébranlable envers leur bien-être.',
      missionExtra: 'Stratégiquement situé au cœur même de Rabat, notre clinique intègre harmonieusement les technologies vétérinaires les plus modernes avec une philosophie de soins traditionnels empreints de compassion. Cette combinaison unique nous permet d\'offrir des services de santé complets adaptés aux besoins divers de tous types d\'animaux de compagnie, garantissant qu\'ils reçoivent une attention médicale exceptionnelle dans un environnement où leur confort et leur santé sont toujours la priorité absolue.',
    ...
    contact: {
      ...
      subtitle: 'Contactez-nous pour des rendez-vous ou des urgences',
      address: 'Adresse',
      phone: 'Téléphone',
      email: 'Email',
